jQuery(function (t) {
    ...
    var e = function (t) {
        ...
        r = function (e, o) {
            ...
            if (0 !== t(".woocommerce-cart-form").length) {
                if (
                    ...
                    var u = t(".wc-empty-cart-message", c).closest(
                        ".woocommerce"
                    );
                    t(".woocommerce-cart-form__contents")
                        ...
                        .replaceWith(u),
                        s.length > 0 && n(s),
                        t(document.body).trigger("wc_cart_emptied");
                } else
        ...
        n = function (e, o) {
            o ||
                (o =
                    t(".woocommerce-notices-wrapper:first") ||
                    t(".wc-empty-cart-message").closest(".woocommerce") ||
                    t(".woocommerce-cart-form")),
                o.prepend(e);
        },
        s = {
            ...
            toggle_shipping: function () {
                return (
                    t(".shipping-calculator-form").slideToggle("slow"),
                    t(
            ...
            shipping_method_selected: function () {
                ...
                t(
                    ...
                    o[t(this).data("index")] = t(this).val();
                }),
                    c(t("div.cart_totals"));
                var r = {
        ...
        u = {
            init: function () {
                (this.update_cart_totals = this.update_cart_totals.bind(this)),
                    ...
                    (this.item_restore_clicked =
                        this.item_restore_clicked.bind(this)),
                    (this.update_cart = this.update_cart.bind(this)),
                    t(document).on("wc_update_cart added_to_cart", function () {
                        u.update_cart.apply(u, [].slice.call(arguments, 1));
                    }),
                    t(document).on(
                        "click",
            ...
            input_keypress: function (e) {
                if (13 === e.keyCode) {
                    var o = t(e.currentTarget).parents("form");
                    try {
                        o[0].checkValidity() &&
            ...
            cart_submit: function (e) {
                var c = t(document.activeElement),
                    ...
                    r = t(e.currentTarget);
                if (
                    (r.is("form") || (r = t(e.currentTarget).parents("form")),
                    0 !== r.find(".woocommerce-cart-form__contents").length)
                )
                    return (
                        !o(r) &&
                        void (i.is(':input[name="update_cart"]') ||
                        c.is("input.qty")
                            ? (e.preventDefault(), this.quantity_update(r))
                            : (i.is(':input[name="apply_coupon"]') ||
                                  c.is("#coupon_code")) &&
                              (e.preventDefault(), this.apply_coupon(r)))
                    );
            },
            submit_click: function (e) {
                t(
                    ":input[type=submit]",
                    t(e.target).parents("form")
                ).removeAttr("clicked"),
            ...
            remove_coupon_clicked: function (o) {
                o.preventDefault();
                var r = this,
                    a = t(o.currentTarget).closest(".cart_totals"),
