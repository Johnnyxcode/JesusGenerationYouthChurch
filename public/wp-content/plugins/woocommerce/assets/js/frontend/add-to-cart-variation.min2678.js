    ...
    (r.prototype.onReset = function (t) {
            ...
            if (r.count && r.count === r.chosenCount)
                if (e.useAjax)
                    e.xhr && e.xhr.abort(),
                        ...
                        (o.product_id = parseInt(
                            e.$form.data("product_id"),
                            10
                        )),
                    ...
                    var n = e
                        .findMatchingVariations(e.variationData, o)
                        .shift();
                    n
        ...
        (r.prototype.onFoundVariation = function (a, i) {
            ...
            if (
                ...
                i.weight
                    ? n.wc_set_content(i.weight_html)
                    : n.wc_reset_content(),
                i.dimensions
                ...
                (l = isNaN(l)
                    ? i.min_qty
                    : (l = l > parseFloat(i.max_qty) ? i.max_qty : l) <
        ...
        (t.fn.wc_variations_image_update = function (i) {
            ...
            if (i && i.image && i.image.src && i.image.src.length > 1) {
                n.find(
                    'li img[data-o_src="' + i.image.gallery_thumbnail_src + '"]'
                ).length > 0 && e.wc_variations_image_reset();
                var m = n.find(
                    'li img[src="' + i.image.gallery_thumbnail_src + '"]'
                );
                if (m.length > 0)
                    return (
                        m.trigger("click"),
