    ...
    $.infinitescroll.prototype = {
        _binding: function infscr_binding(binding) {
            ...
            if (binding == "unbind") {
                this.options.binder.unbind(
                    "smartscroll.infscr." + instance.options.infid
                );
            } else {
                this.options.binder[binding](
                    "smartscroll.infscr." + instance.options.infid,
                    function () {
                        instance.scroll();
                    }
        ...
        _create: function infscr_create(options, callback) {
            ...
            opts.loading.selector =
                opts.loading.selector || opts.contentSelector;
            if (!path) {
            ...
            opts.pixelsFromNavToBottom =
                $(document).height() - $(opts.navSelector).offset().top;
            opts.loading.start =
                opts.loading.start ||
                function () {
        ...
        _nearbottom: function infscr_nearbottom() {
            ...
            return (
                pixelsFromWindowBottomToBottom - opts.bufferPx <
                opts.pixelsFromNavToBottom
            );
        },
        _pausing: function infscr_pausing(pause) {
            ...
            pause =
                pause && (pause == "pause" || pause == "resume")
                    ? pause
                    : "toggle";
            switch (pause) {
                case "pause":
        ...
        retrieve: function infscr_retrieve(pageNum) {
            ...
            beginAjax = function infscr_ajax(opts) {
                ...
                method =
                    opts.dataType == "html" || opts.dataType == "json"
                        ? opts.dataType
                        : "html+callback";
                ...
                switch (method) {
                    ...
                    case "json":
                        ...
                        $.ajax({
                            ...
                            complete: function infscr_ajax_callback(
                                jqXHR,
                                textStatus
                            ) {
                                condition =
                ...
                this.each(function () {
                    ...
                    if (instance) {
                        ...
                        $.data(
                            this,
                            "infinitescroll",
                            new $.infinitescroll(options, callback, this)
                        );
                    }
                });
                break;
